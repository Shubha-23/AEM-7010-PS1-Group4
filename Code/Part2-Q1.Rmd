...
T4$X1[1] <- paste(fit11$coefficients[2],"(",")",se11)
T4$X1[2] <- paste(fit12$coefficients[2],"(",")",se12)  
T4$X1[3] <- elast1  
T4$X1[4] <- pct_effect1
T4$X1[5] <- obs1
T4$X1[6] <- R_sqrd1

T4$X2[1] <- paste(fit21$coefficients[2],"(",")",se21)
T4$X2[2] <- paste(fit22$coefficients[2],"(",")",se22)  
T4$X2[3] <- elast2  
T4$X2[4] <- pct_effect2
T4$X2[5] <- obs2
T4$X2[6] <- R_sqrd2

T4$X3[1] <- paste(fit31$coefficients[2],"(",")",se31)
T4$X3[2] <- paste(fit32$coefficients[2],"(",")",se32)  
T4$X3[3] <- elast3  
T4$X3[4] <- pct_effect3
T4$X3[5] <- obs3
T4$X3[6] <- R_sqrd3

T4$X4[1] <- paste(fit41$coefficients[2],"(",")",se41)
T4$X4[2] <- paste(fit42$coefficients[2],"(",")",se41)  
T4$X4[3] <- elast4  
T4$X4[4] <- pct_effect4
T4$X4[5] <- obs4
T4$X4[6] <- R_sqrd4

T4$X5[1] <- paste(fit51$coefficients[2],"(",")",se51)
T4$X5[2] <- paste(fit52$coefficients[2],"(",")",se51)  
T4$X5[3] <- elast5  
T4$X5[4] <- pct_effect5
T4$X5[5] <- obs5
T4$X5[6] <- R_sqrd5

T4$X6[1] <- paste(fit61$coefficients[2],"(",")",se61)
T4$X6[2] <- paste(fit62$coefficients[2],"(",")",se61)  
T4$X6[3] <- elast6  
T4$X6[4] <- pct_effect6
T4$X6[5] <- obs6
T4$X6[6] <- R_sqrd6
