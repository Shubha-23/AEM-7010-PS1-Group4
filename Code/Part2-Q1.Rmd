...
T3R3
# SE = SQR(VAR/N + VAR/N)
change_mean_PA <- T3R3$mean[4] - T3R3$mean[1]
change_mean_PA_se <- sqrt(T3R3$var[4]/T3R3$n[4] + T3R3$var[1]/T3R3$n[1])

change_mean_NJ <- T3R3$mean[5] - T3R3$mean[2]
change_mean_NJ_se <- sqrt(T3R3$var[5]/T3R3$n[5] + T3R3$var[2]/T3R3$n[2]) 

DD <- change_mean_NJ - change_mean_PA
DD_se <- sqrt(T3R3$var[4]/T3R3$n[4] + T3R3$var[1]/T3R3$n[1] + T3R3$var[5]/T3R3$n[5] + T3R3$var[2]/T3R3$n[2]) 

# organzie them together
T3R3_m <- data.frame() 
```
