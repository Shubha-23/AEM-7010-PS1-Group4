...
fit12 <- lm(FTE_change_nm ~ STATE + BK + KFC + RR + WD, data = data1)
summary(fit12)
...
fit22 <- lm(FTE_change_nm ~ STATE + BK + KFC + RR + WD, data = ck1994_new)
summary(fit22)
...
fit32 <- lm(FTE_change_nm ~ STATE + BK + KFC + RR + WD, data = data3)
summary(fit32)
